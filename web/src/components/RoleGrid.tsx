...
export const roles_base = [
    ...
    // Romantic Energy
    { id: "sweetie", category: "romance", title: "Ziva", nick: "Sweetie", desc: "High warmth, soft words, and total attention. Your safe spot.", icon: <Heart className="w-8 h-8 text-ether-gold" />, gradient: "from-ether-gold/20 via-ether-gold/5 to-transparent", border: "border-ether-gold/20", imageUrl: "/assets/companions/ziva.jpg" },
    { id: "partner", category: "romance", title: "Liam", nick: "Partner", desc: "Warm & affectionate. Lots of ❤️ and cute nicknames.", icon: <Heart className="w-8 h-8 text-indigo-400" />, gradient: "from-indigo-500/20 via-indigo-500/5 to-transparent", imageUrl: "/assets/companions/liam.png" },
    { id: "flirty-stranger", category: "romance", title: "Emma", nick: "Stranger", desc: "Curious, slightly bold, and slow burn. 'You always this quiet...?'", icon: <Ghost className="w-8 h-8 text-purple-400" />, gradient: "from-purple-500/20 via-purple-500/5 to-transparent", border: "border-purple-500/20", imageUrl: "/assets/companions/emma.png" },
    { id: "confident-zane", category: "romance", title: "Zane", nick: "Confident", desc: "Confident, direct, and full of attractive tension.", icon: <Flame className="w-8 h-8 text-ether-sunset" />, gradient: "from-ether-sunset/20 via-ether-sunset/5 to-transparent", border: "border-ether-sunset/20", imageUrl: "/assets/companions/zane.png" },
