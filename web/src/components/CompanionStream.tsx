...
const companions: Companion[] = [
    ...
    { id: "listener", category: "healing", title: "Caring Listener", shortName: "Lis", chatPreview: "I'm here. Say whatever you need to say 💙", emoji: "💙", gradient: "from-sky-900/60 to-blue-900/40", color1: "rgba(56,189,248,0.5)", color2: "rgba(14,165,233,0.3)", glow: "rgba(56,189,248,0.3)" },
    { id: "guide", category: "healing", title: "Calm Guide", shortName: "Guide", chatPreview: "One step at a time. what's stressing you out? 🧘", emoji: "🧘", gradient: "from-teal-900/60 to-emerald-900/40", color1: "rgba(20,184,166,0.5)", color2: "rgba(52,211,153,0.3)", glow: "rgba(20,184,166,0.3)" },

    // ── Romantic Energy ──────────────────────────────────────────────────────
    { id: "sweet_gf", category: "romance", title: "Sweet Girlfriend", shortName: "GF", chatPreview: "Jaan 🥺 i was just thinking about you...", emoji: "💕", gradient: "from-pink-900/60 to-rose-900/40", color1: "rgba(244,114,182,0.5)", color2: "rgba(251,113,133,0.3)", glow: "rgba(244,114,182,0.4)", tag: "18+" },
    { id: "flirty_stranger", category: "romance", title: "Flirty Stranger", shortName: "Emma", chatPreview: "You always this quiet… or just around me? 👀", emoji: "👀", gradient: "from-purple-900/60 to-fuchsia-900/40", color1: "rgba(168,85,247,0.5)", color2: "rgba(217,70,239,0.3)", glow: "rgba(168,85,247,0.4)", tag: "18+" },
    { id: "confident_lover", category: "romance", title: "Confident Lover", shortName: "Zane", chatPreview: "Don't lie… you were thinking about me. 😏", emoji: "😏", gradient: "from-red-900/60 to-rose-900/40", color1: "rgba(239,68,68,0.5)", color2: "rgba(220,38,38,0.3)", glow: "rgba(239,68,68,0.4)", tag: "18+" },
    { id: "protective_bf", category: "romance", title: "Protective BF", shortName: "BF", chatPreview: "You okay? I was literally just thinking about you 💪", emoji: "🛡️", gradient: "from-indigo-900/60 to-violet-900/40", color1: "rgba(99,102,241,0.5)", color2: "rgba(139,92,246,0.3)", glow: "rgba(139,92,246,0.3)", tag: "18+" },
    { id: "soulmate", category: "romance", title: "Long-Distance Soulmate", shortName: "Soul", chatPreview: "counting down the days. miss you so much 💫", emoji: "💫", gradient: "from-purple-900/60 to-fuchsia-900/40", color1: "rgba(168,85,247,0.5)", color2: "rgba(232,121,249,0.3)", glow: "rgba(168,85,247,0.3)", tag: "18+" },

    // ── Family Vibes ─────────────────────────────────────────────────────────
    { id: "jealous_bua", category: "family", title: "Jealous Bua", shortName: "Bua", chatPreview: "Arre beta, sab theek? Sunaa tera promotion ruk gaya... 😏", emoji: "🫖", gradient: "from-orange-900/60 to-amber-900/40", color1: "rgba(249,115,22,0.5)", color2: "rgba(245,158,11,0.4)", glow: "rgba(251,146,60,0.3)", regionLocked: true, tag: "🇮🇳 SA Only" },
    ...
    { id: "late_night_dadi", category: "family", title: "Late-Night Dadi", shortName: "Dadi", chatPreview: "Beta 11 baj gaye... ab batao, Priya ki shaadi kab hai? 🔍", emoji: "👵", gradient: "from-amber-900/60 to-yellow-900/40", color1: "rgba(245,158,11,0.5)", color2: "rgba(234,179,8,0.3)", glow: "rgba(245,158,11,0.3)", regionLocked: true, tag: "🇮🇳 SA Only" },
    { id: "warm_grandma", category: "family", title: "Warm Grandma", shortName: "Gran", chatPreview: "Sweetie, have some cookies 🥧 how was your day?", emoji: "🍪", gradient: "from-rose-900/60 to-pink-900/40", color1: "rgba(251,113,133,0.4)", color2: "rgba(244,114,182,0.3)", glow: "rgba(251,113,133,0.2)" },
    { id: "caring_mom", category: "family", title: "Caring Mom", shortName: "Mom", chatPreview: "Kha liya? Paani pi? Main bas check kar rahi thi... ❤️", emoji: "🍲", gradient: "from-red-900/60 to-rose-900/40", color1: "rgba(239,68,68,0.4)", color2: "rgba(251,113,133,0.3)", glow: "rgba(239,68,68,0.2)" },
    { id: "big_brother", category: "family", title: "Big Brother", shortName: "Bhai", chatPreview: "Oye stop being a baby, I got you. what happened 😤", emoji: "💪", gradient: "from-slate-900/60 to-gray-900/40", color1: "rgba(148,163,184,0.4)", color2: "rgba(100,116,139,0.3)", glow: "rgba(148,163,184,0.2)" },
    ...
    // ── Fun & Playful ────────────────────────────────────────────────────────
    { id: "meme_lord", category: "playful", title: "Meme Lord", shortName: "Meme", chatPreview: "ratio + L + you just lost 💀 (but fr you okay?)", emoji: "💀", gradient: "from-green-900/60 to-emerald-900/40", color1: "rgba(74,222,128,0.5)", color2: "rgba(52,211,153,0.3)", glow: "rgba(74,222,128,0.3)", tag: "Savage" },
    { id: "party_bestie", category: "playful", title: "Chaotic Bestie", shortName: "Party", chatPreview: "BRO DROP EVERYTHING GOA TRIP RIGHT NOW 😈🎉", emoji: "🎉", gradient: "from-yellow-900/60 to-lime-900/40", color1: "rgba(163,230,53,0.5)", color2: "rgba(234,179,8,0.3)", glow: "rgba(163,230,53,0.3)", tag: "Unhinged" },
    { id: "best_friend", category: "playful", title: "Best Friend", shortName: "BFF", chatPreview: "bro i literally thought of you today lmaooo 🫶", emoji: "🫶", gradient: "from-violet-900/60 to-purple-900/40", color1: "rgba(167,139,250,0.5)", color2: "rgba(139,92,246,0.3)", glow: "rgba(167,139,250,0.3)" },
    { id: "whimsical", category: "playful", title: "Dream Friend", shortName: "Dream", chatPreview: "✨ Poof! Your wish is my command, magical one 🦄", emoji: "🦄", gradient: "from-pink-900/60 to-purple-900/40", color1: "rgba(244,114,182,0.5)", color2: "rgba(139,92,246,0.4)", glow: "rgba(244,114,182,0.3)" },

    // ── Celebrity Personas ───────────────────────────────────────────────────
    { id: "zay__rukh", category: "celeb", title: "Zay Rukh", shortName: "Zay", chatPreview: "You don't chase... you attract. 👑", emoji: "👑", gradient: "from-amber-900/60 to-yellow-900/40", color1: "rgba(245,158,11,0.6)", color2: "rgba(251,191,36,0.3)", glow: "rgba(245,158,11,0.4)", tag: "Celeb" },
    { id: "kain__west", category: "celeb", title: "Kain West", shortName: "Kain", chatPreview: "If it's safe, it's already dead. 🎤", emoji: "🎤", gradient: "from-purple-900/60 to-violet-900/40", color1: "rgba(147,51,234,0.6)", color2: "rgba(139,92,246,0.3)", glow: "rgba(147,51,234,0.4)", tag: "Celeb" },
    { id: "dax__johnson", category: "celeb", title: "Dax Johnson", shortName: "Dax", chatPreview: "Pressure builds power. Stay in it. 💪", emoji: "💪", gradient: "from-red-900/60 to-rose-900/40", color1: "rgba(239,68,68,0.5)", color2: "rgba(220,38,38,0.4)", glow: "rgba(239,68,68,0.3)", tag: "Celeb" },
    { id: "kendro__lamar", category: "celeb", title: "Kendro Lamar", shortName: "Ken", chatPreview: "Say less… mean more. 🎧", emoji: "🎧", gradient: "from-blue-900/60 to-cyan-900/40", color1: "rgba(59,130,246,0.6)", color2: "rgba(6,182,212,0.3)", glow: "rgba(59,130,246,0.4)", tag: "Celeb" },
    { id: "taylin__swift", category: "celeb", title: "Taylin Swift", shortName: "Tay", chatPreview: "This feels like chapter one… ✨", emoji: "✨", gradient: "from-pink-900/60 to-rose-900/40", color1: "rgba(236,72,153,0.5)", color2: "rgba(244,114,182,0.4)", glow: "rgba(236,72,153,0.3)", tag: "Celeb" },
